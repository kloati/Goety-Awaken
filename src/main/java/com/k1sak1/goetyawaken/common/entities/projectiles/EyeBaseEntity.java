...
public abstract class EyeBaseEntity extends net.minecraft.world.entity.projectile.Projectile implements ItemSupplier {
    private static final EntityDataAccessor<ItemStack> DATA_ITEM_STACK = SynchedEntityData.defineId(EyeBaseEntity.class,
            EntityDataSerializers.ITEM_STACK);
    private static final EntityDataAccessor<ParticleOptions> DATA_PARTICLE = SynchedEntityData
            .defineId(EyeBaseEntity.class, EntityDataSerializers.PARTICLE);
    private static final EntityDataAccessor<Integer> DATA_LIFE = SynchedEntityData.defineId(EyeBaseEntity.class,
    ...
    public EyeBaseEntity(EntityType<? extends EyeBaseEntity> pEntityType, Level pLevel) {
    ...
    protected void defineSynchedData() {
        ...
        this.getEntityData().define(DATA_LIFE, 0);
    }
    ...
    public void tick() {
        ...
        this.setXRot(net.minecraft.world.entity.projectile.Projectile.lerpRotation(this.xRotO,
                (float) (Mth.atan2(vec3.y, d3) * (double) (180F / (float) Math.PI))));
        this.setYRot(net.minecraft.world.entity.projectile.Projectile.lerpRotation(this.yRotO,
                (float) (Mth.atan2(vec3.x, vec3.z) * (double) (180F / (float) Math.PI))));
        ...
        if (this.isInWater()) {
            ...
            this.level().addParticle(this.getParticle(), d0 - vec3.x * 0.25D + this.random.nextDouble() * 0.6D - 0.3D,
        ...
        if (!this.level().isClientSide) {
            ...
            ++this.life;
            this.getEntityData().set(DATA_LIFE, this.life);
            ...
            this.life = this.getEntityData().get(DATA_LIFE);
        }
    }
