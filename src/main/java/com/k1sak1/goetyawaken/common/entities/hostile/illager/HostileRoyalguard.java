...
public class HostileRoyalguard extends HuntingIllagerEntity implements ICustomAttributes {
    ...
    public HostileRoyalguard(EntityType<? extends HuntingIllagerEntity> type, Level worldIn) {
        super(type, worldIn);
    }
