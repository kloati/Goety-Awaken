...
public class FrozenZombie extends Zombie implements Enemy, RangedAttackMob {
    public int throwCooldown;

    public FrozenZombie(EntityType<? extends Zombie> type, Level worldIn) {
        super(type, worldIn);
    }
    ...
    static class ThrowSnowballGoal extends Goal {
        public FrozenZombie zombie;
        public int start;

        public ThrowSnowballGoal(FrozenZombie zombie) {
            this.zombie = zombie;
