...
public class WindCaller extends HuntingIllagerEntity implements ICustomAttributes {
    private static final EntityDataAccessor<Integer> ANIM_STATE = SynchedEntityData.defineId(WindCaller.class,
    ...
    public WindCaller(EntityType<? extends HuntingIllagerEntity> type, Level worldIn) {
        super(type, worldIn);
    }
    ...
    public void miscGoal() {
        ...
        this.goalSelector.addGoal(8, new WindCallerWanderGoal(this, 0.6D));
        this.goalSelector.addGoal(9, new LookAtPlayerGoal(this, Player.class, 3.0F, 1.0F));
        this.goalSelector.addGoal(10, new LookAtPlayerGoal(this, Mob.class, 8.0F));
    }

    static class WindCallerWanderGoal extends RandomStrollGoal {
        public WindCallerWanderGoal(SpellcasterIllager p_25983_, double p_25984_) {
    ...
    public void setConfigurableAttributes() {
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH),
                AttributesConfig.WindCallerServantHealth.get());
        ...
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.FOLLOW_RANGE),
                AttributesConfig.WindCallerServantFollowRange.get());
    }
    ...
    public boolean isAttacking() {
        return this.getCurrentAnimation() == this.getAnimationState(BLAST)
                || this.getCurrentAnimation() == this.getAnimationState(UPDRAFT);
    }
        ...
        if (this.level() instanceof ServerLevel serverLevel) {
            ...
            if (this.isAlive()) {
                ServerParticleUtil.windParticle(serverLevel, ColorUtil.WHITE,
                        0.5F + serverLevel.random.nextFloat() * 0.5F, 0.0F, this.getId(), this.position());
    ...
    public static class BlastGoal extends Goal {
        public WindCaller windCaller;
        public boolean attack = false;
        public int spellTick;

        public BlastGoal(WindCaller windCaller) {
    ...
    public static class UpdraftGoal extends Goal {
        ...
        public UpdraftGoal(WindCaller windCaller) {
            this.windCaller = windCaller;
            this.setFlags(EnumSet.of(Flag.TARGET, Flag.LOOK));
        }
