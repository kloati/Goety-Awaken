...
public class SetWardenLookTargetServant {
    public static BehaviorControl<WardenServant> create() {
        return BehaviorBuilder.create((p_258946_) -> {
            return p_258946_
                    .group(p_258946_.registered(MemoryModuleType.LOOK_TARGET),
