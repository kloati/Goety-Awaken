...
public class RedstoneClusterMiddleBlock extends Block {
    private static final VoxelShape SHAPE = createShape();
    private final int signalStrength;

    public RedstoneClusterMiddleBlock(int signalStrength) {
        super(BlockBehaviour.Properties.of()
                .mapColor(MapColor.COLOR_RED)
                .requiresCorrectToolForDrops()
                .strength(5.0F, 6.0F)
                .lightLevel(state -> signalStrength > 0 ? 4 : 0));
        this.signalStrength = signalStrength;
    }

    private static VoxelShape createShape() {
        VoxelShape core = Block.box(4, 0, 4, 11, 12, 11);
        VoxelShape out1 = Block.box(3, 1, 2, 5, 5, 4);
        VoxelShape out2 = Block.box(3, 3, 6, 5, 5, 8);
        VoxelShape out3 = Block.box(0, 0, 10, 4, 8, 14);
        VoxelShape out4 = Block.box(11, 0, 6, 14, 7, 9);
        VoxelShape out5 = Block.box(11, 0, 3, 13, 2, 5);
