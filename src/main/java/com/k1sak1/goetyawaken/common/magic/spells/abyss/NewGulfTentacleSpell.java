package com.k1sak1.goetyawaken.common.magic.spells.abyss;
...
public class NewGulfTentacleSpell extends Spell {
    ...
    public void SpellResult(ServerLevel worldIn, LivingEntity caster, ItemStack staff, SpellStat spellStat) {
        ...
        Vec3 vec3 = caster.getEyePosition().add(-d0 * d3, (double) f3 - 0.45F, d1 * d3);
        ...
        if (potency > 0) {
            ...
            gulfTentacle.addEffect(
                    new MobEffectInstance(GoetyEffects.BUFF.get(), EffectsUtil.infiniteEffect(), boost, false, false));
        }
