package com.k1sak1.goetyawaken.common.magic.spells.void_spells;
...
public class StareSpell extends SummonSpell {
    @Override
    public int defaultSoulCost() {
        return Config.STARE_FOCUS_SOUL_COST.get();
    }

    @Override
    public int defaultCastDuration() {
        return Config.STARE_FOCUS_CAST_DURATION.get();
    }
    ...
    public int defaultSpellCooldown() {
        return Config.STARE_FOCUS_COOLDOWN.get();
    }

    @Override
    public int SummonDownDuration() {
        return Config.stareFocusCooldown;
    }
    ...
    public Predicate<LivingEntity> summonPredicate() {
        return livingEntity -> livingEntity instanceof EndermanServant;
    }

    @Override
    public int summonLimit() {
        return Config.endermanServantLimit;
    }
