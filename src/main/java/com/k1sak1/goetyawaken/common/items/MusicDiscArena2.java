...
public class MusicDiscArena2 extends RecordItem {
    public MusicDiscArena2(int comparatorValue, Supplier<SoundEvent> soundSupplier, Properties properties,
            int lengthInTicks) {
    ...
    public static RecordItem create(Supplier<SoundEvent> soundSupplier) {
        ...
        return new MusicDiscArena2(15, soundSupplier, properties,
                110 * 20);
    }
}
