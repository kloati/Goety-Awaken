...
public class MusicDiscArena1 extends RecordItem {
    public MusicDiscArena1(int comparatorValue, Supplier<SoundEvent> soundSupplier, Properties properties,
            int lengthInTicks) {
    ...
    public static RecordItem create(Supplier<SoundEvent> soundSupplier) {
        ...
        return new MusicDiscArena1(15, soundSupplier, properties,
                100 * 20);
    }
}
