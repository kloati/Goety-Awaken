...
public class BakasmusicDisc extends RecordItem {
    public BakasmusicDisc(int comparatorValue, Supplier<SoundEvent> soundSupplier, Properties properties,
            int lengthInTicks) {
    ...
    public static RecordItem create(Supplier<SoundEvent> soundSupplier) {
        ...
        return new BakasmusicDisc(15, soundSupplier, properties,
                180 * 20);
    }
}