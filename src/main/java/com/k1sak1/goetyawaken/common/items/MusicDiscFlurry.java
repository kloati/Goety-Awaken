...
public class MusicDiscFlurry extends RecordItem {
    public MusicDiscFlurry(int comparatorValue, Supplier<SoundEvent> soundSupplier, Properties properties,
            int lengthInTicks) {
    ...
    public static RecordItem create(Supplier<SoundEvent> soundSupplier) {
        ...
        return new MusicDiscFlurry(15, soundSupplier, properties,
                65 * 20);
    }
}
