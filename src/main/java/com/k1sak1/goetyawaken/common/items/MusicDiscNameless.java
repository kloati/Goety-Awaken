...
public class MusicDiscNameless extends RecordItem {
    public MusicDiscNameless(int comparatorValue, Supplier<SoundEvent> soundSupplier, Properties properties,
            int lengthInTicks) {
    ...
    public static RecordItem create(Supplier<SoundEvent> soundSupplier) {
        ...
        return new MusicDiscNameless(15, soundSupplier, properties,
                240 * 20);
    }
}
