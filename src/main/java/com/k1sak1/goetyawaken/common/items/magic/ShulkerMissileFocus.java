...
import com.k1sak1.goetyawaken.common.magic.spells.ShulkerMissileSpell;
...
public class ShulkerMissileFocus extends MagicFocus {
    public ShulkerMissileFocus() {
        super(new ShulkerMissileSpell());
    }
