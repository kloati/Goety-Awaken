...
public class MusicDiscSwashes extends RecordItem {
    public MusicDiscSwashes(int comparatorValue, Supplier<SoundEvent> soundSupplier, Properties properties,
            int lengthInTicks) {
    ...
    public static RecordItem create(Supplier<SoundEvent> soundSupplier) {
        ...
        return new MusicDiscSwashes(15, soundSupplier, properties,
                100 * 20);
    }
}
