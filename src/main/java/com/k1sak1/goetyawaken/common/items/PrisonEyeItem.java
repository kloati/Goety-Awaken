...
public class PrisonEyeItem extends Item {
    public PrisonEyeItem() {
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pHand) {
        ...
        if (pLevel instanceof ServerLevel serverlevel) {
            BlockPos blockpos = serverlevel.findNearestMapStructure(
                    ModStructureTags.CHAOS_PRISON,
                    pPlayer.blockPosition(),
                    100,
                    false);
            if (blockpos != null) {
                PrisonEyeEntity eyeofender = PrisonEyeEntity.create(pLevel,
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents,
        ...
        pTooltipComponents.add(Component.translatable("tooltip.goetyawaken.prison_eye.desc"));
    }
}