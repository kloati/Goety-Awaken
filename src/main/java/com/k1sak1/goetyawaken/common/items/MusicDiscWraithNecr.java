...
public class MusicDiscWraithNecr extends RecordItem {
    public MusicDiscWraithNecr(int comparatorValue, Supplier<SoundEvent> soundSupplier, Properties properties,
            int lengthInTicks) {
    ...
    public static RecordItem create(Supplier<SoundEvent> soundSupplier) {
        ...
        return new MusicDiscWraithNecr(15, soundSupplier, properties,
                180 * 20);
    }
}