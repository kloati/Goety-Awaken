package com.k1sak1.goetyawaken.client.renderer.util;

import org.joml.Matrix3f;
import org.joml.Matrix4f;
import com.Polarice3.Goety.Goety;
import com.k1sak1.goetyawaken.common.entities.util.SummonApostleServant;
...
public class SummonApostleServantRenderer extends EntityRenderer<SummonApostleServant> {
    ...
    public SummonApostleServantRenderer(EntityRendererProvider.Context p_174008_) {
        super(p_174008_);
    }

    public void render(SummonApostleServant entityIn, float entityYaw, float partialTicks, PoseStack matrixStackIn,
    ...
    public void drawVertex(Matrix4f matrix4f, Matrix3f matrix3f, VertexConsumer vertexConsumer, float x, float y,
            float z, float u, float v, float normalX, float normalY, float normalZ) {
        vertexConsumer.vertex(matrix4f, x, y, z).color(255, 255, 255, 255).uv(u, v)
                .overlayCoords(OverlayTexture.NO_OVERLAY).uv2(LightTexture.FULL_BRIGHT)
                .normal(matrix3f, normalX, normalY, normalZ).endVertex();
    }

    public boolean shouldRender(SummonApostleServant p_114491_, Frustum p_114492_, double p_114493_, double p_114494_,
            double p_114495_) {
        if (p_114491_.noCulling) {
            ...
            if (aabb.hasNaN() || aabb.getSize() == 0.0D) {
                aabb = new AABB(p_114491_.getX() - size, p_114491_.getY() - size, p_114491_.getZ() - size,
                        p_114491_.getX() + size, p_114491_.getY() + size, p_114491_.getZ() + size);
            }
    ...
    @Override
    public ResourceLocation getTextureLocation(SummonApostleServant p_114482_) {
        return TEXTURE;
    }
}