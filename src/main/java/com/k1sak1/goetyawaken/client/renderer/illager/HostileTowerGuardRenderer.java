...
public class HostileTowerGuardRenderer extends MobRenderer<HostileTowerGuard, TowerGuardModel<HostileTowerGuard>> {
    private static final ResourceLocation TEXTURE = GoetyAwaken
            .location("textures/entity/illager/tower_guard.png");
    ...
    private final TowerGuardModel<HostileTowerGuard> shadowModel;

    public HostileTowerGuardRenderer(EntityRendererProvider.Context ctx) {
    ...
    @Override
    public void render(HostileTowerGuard entity, float entityYaw, float partialTicks, PoseStack poseStack,
    ...
    @Override
    public ResourceLocation getTextureLocation(HostileTowerGuard entity) {
        return TEXTURE;
    }
}