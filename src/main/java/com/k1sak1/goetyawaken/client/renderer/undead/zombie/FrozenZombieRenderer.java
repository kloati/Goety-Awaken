...
@OnlyIn(Dist.CLIENT)
public class FrozenZombieRenderer extends HumanoidMobRenderer<FrozenZombie, FrozenZombieModel<FrozenZombie>> {
    ...
    public FrozenZombieRenderer(EntityRendererProvider.Context context) {
        super(context, new FrozenZombieModel<>(context.bakeLayer(ClientEventHandler.FROZEN_ZOMBIE_LAYER)), 0.5F);
