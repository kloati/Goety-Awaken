...
public class ModSwordProjectileRenderer<T extends AbstractArrow & ItemSupplier> extends EntityRenderer<T> {
    private final ItemRenderer itemRenderer;
    private final float scale;
    private final boolean fullBright;

    public ModSwordProjectileRenderer(EntityRendererProvider.Context p_i226035_1_, ItemRenderer p_i226035_2_,
    ...
    public ModSwordProjectileRenderer(EntityRendererProvider.Context p_i50957_1_, ItemRenderer p_i50957_2_) {
