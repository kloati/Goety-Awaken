...
public class CorruptedSoulBoltRenderer extends EntityRenderer<CorruptedSoulBolt> {
      private static final ResourceLocation TRAIL = Goety.location("textures/entity/projectiles/trail.png");
      private final SoulBoltModel<CorruptedSoulBolt> model;

      public CorruptedSoulBoltRenderer(EntityRendererProvider.Context p_174449_) {
            super(p_174449_);
            this.model = new SoulBoltModel<>(p_174449_.bakeLayer(ModModelLayer.SOUL_BOLT));
      }

      protected int getBlockLightLevel(CorruptedSoulBolt p_116491_, BlockPos p_116492_) {
            return 15;
      }

      public void render(CorruptedSoulBolt entityIn, float entityYaw, float partialTicks, PoseStack matrixStackIn,
            ...
            this.model.renderToBuffer(matrixStackIn, vertexconsumer, 15728640, OverlayTexture.NO_OVERLAY, 1.0F, 1.0F,
                        1.0F,
                        0.5F);
            ...
            if (entityIn.hasTrail()) {
                  ...
                  ColorUtil colorUtil = new ColorUtil(0xFF00FF);
                  renderTrail(entityIn, partialTicks, matrixStackIn, bufferIn, colorUtil.red, colorUtil.green,
                              colorUtil.blue,
                              0.6F, packedLightIn);
                  matrixStackIn.popPose();
            }
      ...
      private void renderTrail(CorruptedSoulBolt entityIn, float partialTicks, PoseStack matrixStackIn,
      ...
      public ResourceLocation getTextureLocation(CorruptedSoulBolt p_116482_) {
