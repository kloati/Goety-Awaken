...
public class FrostScytheSlashRenderer extends EntityRenderer<FrostScytheSlash> {

    public FrostScytheSlashRenderer(EntityRendererProvider.Context renderManagerIn) {
        super(renderManagerIn);
    }

    protected int getBlockLightLevel(FrostScytheSlash pEntity, BlockPos pPos) {
        return 15;
    }

    public void render(FrostScytheSlash pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack,
    ...
    private static void vertex(VertexConsumer p_229045_0_, Matrix4f p_229045_1_, Matrix3f p_229045_2_, int p_229045_3_,
            float p_229045_4_, int p_229045_5_, int p_229045_6_, int p_229045_7_) {
    ...
    public ResourceLocation getTextureLocation(FrostScytheSlash entity) {
