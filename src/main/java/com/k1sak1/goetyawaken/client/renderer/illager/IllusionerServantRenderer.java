...
@OnlyIn(Dist.CLIENT)
public class IllusionerServantRenderer
        extends MobRenderer<IllusionerServant, IllusionerServantModel<IllusionerServant>> {
    private static final ResourceLocation ILLUSIONER_SERVANT_LOCATION = new ResourceLocation(GoetyAwaken.MODID,
            "textures/entity/illager/illusioner_servant.png");

    public IllusionerServantRenderer(EntityRendererProvider.Context p_174186_) {
    ...
    public ResourceLocation getTextureLocation(IllusionerServant pEntity) {
        return ILLUSIONER_SERVANT_LOCATION;
    }

    public void render(IllusionerServant pEntity, float pEntityYaw, float pPartialTicks, PoseStack pPoseStack,
    ...
    protected boolean isBodyVisible(IllusionerServant pLivingEntity) {
        return true;
    }
}