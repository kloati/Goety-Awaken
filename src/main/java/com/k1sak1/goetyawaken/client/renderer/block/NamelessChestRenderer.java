...
public class NamelessChestRenderer implements BlockEntityRenderer<NamelessChestBlockEntity> {
    private static final ResourceLocation TEXTURES = GoetyAwaken.location("textures/entity/chest/nameless/normal.png");
    private final ModelPart lid;
    private final ModelPart bottom;
    private final ModelPart lock;

    public NamelessChestRenderer(BlockEntityRendererProvider.Context p_173607_) {
        ModelPart modelpart = p_173607_.bakeLayer(ModBlockLayer.NAMELESS_CHEST);
    ...
    @Override
    public void render(@Nonnull NamelessChestBlockEntity p_112363_, float p_112364_, @Nonnull PoseStack p_112365_,
            @Nonnull MultiBufferSource p_112366_, int p_112367_,
            int p_112368_) {
