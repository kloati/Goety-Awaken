...
public class BoneLordServantRenderer extends HumanoidMobRenderer<BoneLordServant, SkeletonModel<BoneLordServant>> {
    ...
    public BoneLordServantRenderer(EntityRendererProvider.Context p_174382_, ModelLayerLocation p_174383_,
            ModelLayerLocation p_174384_, ModelLayerLocation p_174385_) {
        super(p_174382_, new SkeletonModel<>(p_174382_.bakeLayer(p_174383_)), 0.5F);
        this.addLayer(new HumanoidArmorLayer<>(this, new SkeletonModel<>(p_174382_.bakeLayer(p_174384_)),
                new SkeletonModel<>(p_174382_.bakeLayer(p_174385_)), p_174382_.getModelManager()) {
    ...
    public void render(BoneLordServant pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack,
            MultiBufferSource pBuffer, int pPackedLight) {
        SkeletonModel<BoneLordServant> skeletonModel = this.getModel();
        skeletonModel.head.visible = false;
        super.render(pEntity, pEntityYaw, pPartialTicks, pMatrixStack, pBuffer, pPackedLight);
    }

    public ResourceLocation getTextureLocation(BoneLordServant entity) {
