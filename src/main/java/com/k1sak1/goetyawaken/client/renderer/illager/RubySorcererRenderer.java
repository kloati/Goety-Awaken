...
public class RubySorcererRenderer<T extends RubySorcerer> extends MobRenderer<T, SorcererModel<T>> {
    protected static final ResourceLocation TEXTURE = Goety
            .location("textures/entity/illagers/sorcerer/sorcerer.png");

    public RubySorcererRenderer(EntityRendererProvider.Context renderManagerIn) {
    ...
    public static class CastLevelLayer<T extends RubySorcerer, M extends SorcererModel<T>>
        ...
        public void render(PoseStack p_116983_, MultiBufferSource p_116984_, int p_116985_, T p_116986_,
            ...
            if (!p_116986_.isInvisible()) {
                ResourceLocation resourcelocation2 = LEVEL_LOCATIONS
                        .get(Mth.clamp(p_116986_.getSorcererLevel(), 1, LEVEL_LOCATIONS.size()));
