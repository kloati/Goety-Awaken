...
public class GiantGhastFireballRenderer extends EntityRenderer<GiantGhastFireball> {
    private final com.Polarice3.Goety.client.render.model.HellBlastModel<GiantGhastFireball> model;

    public GiantGhastFireballRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
        this.model = new com.Polarice3.Goety.client.render.model.HellBlastModel<>(
                pContext.bakeLayer(ClientEventHandler.GIANT_GHAST_FIREBALL_LAYER));
    }

    protected int getBlockLightLevel(GiantGhastFireball pEntity, BlockPos pPos) {
        return 15;
    }

    public void render(GiantGhastFireball p_116484_, float p_116485_, float p_116486_, PoseStack p_116487_,
    ...
    public ResourceLocation getTextureLocation(GiantGhastFireball pEntity) {
