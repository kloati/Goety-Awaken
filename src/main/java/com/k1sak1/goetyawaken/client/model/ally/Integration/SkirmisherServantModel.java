...
public class SkirmisherServantModel extends HierarchicalModel<SkirmisherServant>
    ...
    public SkirmisherServantModel(ModelPart root) {
        this.root = root;
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        partdefinition1.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(32, 0).addBox(-0.5F, -15.0F, -5.0F,
                1.0F, 6.0F, 10.0F, new CubeDeformation(-0.5F)), PartPose.ZERO);
        ...
        partdefinition.addOrReplaceChild(
                "body", CubeListBuilder.create().texOffs(16, 20).addBox(-4.0F, 0.0F, -3.0F, 8.0F, 12.0F, 6.0F)
    ...
    public void setupAnim(SkirmisherServant skirmisher, float limbSwing, float limbSwingAmount, float ageInTicks,
        ...
        AbstractIllagerServant.IllagerServantArmPose abstractillager$illagerarmpose = skirmisher.getArmPose();
        if (abstractillager$illagerarmpose == AbstractIllagerServant.IllagerServantArmPose.ATTACKING) {
        ...
        } else if (abstractillager$illagerarmpose == AbstractIllagerServant.IllagerServantArmPose.SPELLCASTING) {
            ...
            this.right_arm.yRot = 0.0F;
            this.left_arm.yRot = 0.0F;
        } else if (abstractillager$illagerarmpose == AbstractIllagerServant.IllagerServantArmPose.BOW_AND_ARROW) {
        ...
        } else if (abstractillager$illagerarmpose == AbstractIllagerServant.IllagerServantArmPose.CROSSBOW_HOLD) {
            AnimationUtils.animateCrossbowHold(this.right_arm, this.left_arm, this.head, true);
        } else if (abstractillager$illagerarmpose == AbstractIllagerServant.IllagerServantArmPose.CROSSBOW_CHARGE) {
            AnimationUtils.animateCrossbowCharge(this.right_arm, this.left_arm, skirmisher, true);
        } else if (abstractillager$illagerarmpose == AbstractIllagerServant.IllagerServantArmPose.CELEBRATING) {
            this.right_arm.z = 0.0F;
            this.right_arm.x = -5.0F;
