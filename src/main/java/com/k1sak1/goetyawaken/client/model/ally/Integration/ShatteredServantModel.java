...
public class ShatteredServantModel extends HierarchicalModel<ShatteredServant> {
	private final ModelPart root;
	private final ModelPart head;

	public ShatteredServantModel(ModelPart root) {
		this.root = root;
	...
	public static LayerDefinition createBodyModel() {
		...
		PartDefinition body = root.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(16, 16)
						...
						.texOffs(37, 6).mirror()
						.addBox(0.0F, -11.0F, 2.0F, 0.0F, 11.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(0.0F, -13.0F, 0.0F));
		body.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F))
						.texOffs(32, 0).addBox(-12.0F, -11.0F, 0.0F, 8.0F, 8.0F, 0.0F, new CubeDeformation(0.0F))
						.texOffs(40, 0).mirror().addBox(4.0F, -11.0F, 0.0F, 8.0F, 8.0F, 0.0F, new CubeDeformation(0.0F))
						.mirror(false),
				PartPose.offset(0.0F, -13.0F, 0.0F));
		...
		arms.addOrReplaceChild("right_arm",
				CubeListBuilder.create().texOffs(0, 16)
						...
						.texOffs(43, 8).addBox(-4.0F, 11.0F, -2.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-4.0F, 0.0F, 0.0F));
		arms.addOrReplaceChild("left_arm",
				CubeListBuilder.create().texOffs(40, 16)
						.addBox(0.0F, -2.0F, -2.0F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.0F))
						.texOffs(44, 27).addBox(1.0F, 5.0F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(4.0F, 0.0F, 0.0F));
		...
		legs.addOrReplaceChild("right_leg",
				CubeListBuilder.create().texOffs(0, 33)
						...
						.texOffs(0, 47).addBox(-2.0F, 8.0F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.0F, 0.0F, 0.0F));
		legs.addOrReplaceChild("left_leg", CubeListBuilder.create().texOffs(16, 33).addBox(-2.0F, 0.0F, -2.0F, 4.0F,
				13.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(2.0F, 0.0F, 0.0F));

		return LayerDefinition.create(mesh, 64, 64);
	}

	@Override
	public void setupAnim(ShatteredServant entity, float limbSwing, float limbSwingAmount, float ageInTicks,
