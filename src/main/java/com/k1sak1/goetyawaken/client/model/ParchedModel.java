...
public class ParchedModel<T extends Mob> extends HumanoidModel<T> {
        public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(GoetyAwaken.location("parched"),
                        "main");
        ...
        public static LayerDefinition createBodyLayer() {
                ...
                PartDefinition head = partdefinition.addOrReplaceChild("head",
                                CubeListBuilder.create().texOffs(0, 0)
                                                ...
                                                .texOffs(0, 32).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F,
                ...
                PartDefinition body = partdefinition.addOrReplaceChild("body",
                                CubeListBuilder.create().texOffs(16, 16)
                                                .addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F,
                                                                new CubeDeformation(0.0F))
                                                .texOffs(16, 48).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F,
                                                                new CubeDeformation(0.25F)),
                                PartPose.offset(0.0F, -24.0F, 0.0F));

                PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm",
                                CubeListBuilder.create().texOffs(40, 16).mirror()
                                                .addBox(-1.5F, -2.0F, -1.0F, 2.0F, 12.0F, 2.0F,
                                                                new CubeDeformation(0.0F))
                                                .mirror(false)
                                                .texOffs(40, 48).mirror()
                                                .addBox(-1.95F, -2.025F, -1.5F, 3.0F, 12.0F, 3.0F,
                                                                new CubeDeformation(0.0F))
                                                .mirror(false)
                ...
                PartDefinition right_arm = partdefinition.addOrReplaceChild("right_arm",
                                CubeListBuilder.create().texOffs(40, 16)
                                                .addBox(-1.5F, -2.0F, -1.0F, 2.0F, 12.0F, 2.0F,
                                                                new CubeDeformation(0.0F))
                                                .texOffs(42, 33)
                                                .addBox(-2.05F, -2.025F, -1.5F, 3.0F, 12.0F, 3.0F,
                                                                new CubeDeformation(0.0F))
                                                .texOffs(48, 16).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F,
                                                                new CubeDeformation(0.25F)),
                ...
                PartDefinition left_leg = partdefinition.addOrReplaceChild("left_leg",
                                CubeListBuilder.create().texOffs(0, 16).mirror()
                                                ...
                                                .mirror(false)
                                                .texOffs(48, 0).mirror()
                                                .addBox(-2.1F, 0.0F, -1.9F, 4.0F, 12.0F, 4.0F,
                                                                new CubeDeformation(0.25F))
                                                .mirror(false),
                ...
                PartDefinition right_leg = partdefinition.addOrReplaceChild("right_leg",
                                CubeListBuilder.create().texOffs(0, 16)
                                                ...
                                                .addBox(-1.5F, 0.0F, -1.5F, 3.0F, 12.0F, 3.0F,
                                                                new CubeDeformation(0.0F))
                                                .texOffs(48, 0).addBox(-1.9F, 0.0F, -1.9F, 4.0F, 12.0F, 4.0F,
                                                                new CubeDeformation(0.25F)),
                                PartPose.offset(-2.0F, -12.0F, 0.0F));
        ...
        public void setupAnim(T p_103798_, float p_103799_, float p_103800_, float p_103801_, float p_103802_,
                ...
                if (p_103798_.isAggressive() && (itemstack.isEmpty() || !itemstack.is(Items.BOW))) {
                        ...
                        float f1 = Mth.sin(
                                        (1.0F - (1.0F - this.attackTime) * (1.0F - this.attackTime)) * (float) Math.PI);
