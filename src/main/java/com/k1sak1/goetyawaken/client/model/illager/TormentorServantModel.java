...
public class TormentorServantModel extends HumanoidModel<TormentorServant> {
    public final ModelPart clothes;
    private final ModelPart RightWing;
    private final ModelPart LeftWing;

    public TormentorServantModel(ModelPart root) {
        super(root);
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        partdefinition.addOrReplaceChild("right_leg",
                CubeListBuilder.create().texOffs(0, 22).mirror()
                        .addBox(-4.0F, 1.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(1.0F)).mirror(false),
                PartPose.offset(2.0F, 12.0F, 0.0F));

        partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(40, 46).addBox(-3.0F, -2.0F,
                -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-5.0F, 2.0F, 0.0F));
        ...
        body.addOrReplaceChild("clothes", CubeListBuilder.create().texOffs(0, 38).addBox(-4.0F, 0.0F, -3.0F, 8.0F,
                18.0F, 6.0F, new CubeDeformation(0.5F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(
                -4.0F, -10.0F, -4.0F, 8.0F, 10.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        head.addOrReplaceChild("nose", CubeListBuilder.create().texOffs(24, 0).addBox(-1.0F, -1.0F, -6.0F, 2.0F, 4.0F,
                2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -2.0F, 0.0F));

        body.addOrReplaceChild("RightWing", CubeListBuilder.create().texOffs(32, 0).addBox(-16.0F, -1.0F, 0.0F, 16.0F,
                12.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 3.0F, 4.0F));

        body.addOrReplaceChild("LeftWing",
                CubeListBuilder.create().texOffs(32, 0).mirror()
                        .addBox(0.0F, -1.0F, 0.0F, 16.0F, 12.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
    ...
    @Override
    public void setupAnim(TormentorServant entity, float limbSwing, float limbSwingAmount, float ageInTicks,
        ...
        // 移除了原版中依赖getArmPose()的部分，因为TormentorServant没有这个方法
