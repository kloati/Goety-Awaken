...
public class EnderKeeperServantModel<T extends EnderKeeperServant> extends HierarchicalModel<T> {
        ...
        private static LayerDefinition createBodyLayer(float deformation) {
                ...
                PartDefinition head = main.addOrReplaceChild("head",
                                CubeListBuilder.create().texOffs(80, 54).addBox(-4.0F,
                                                -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(deformation)),
                                PartPose.offset(0.0F, 0.0F, 0.0F));
                ...
                PartDefinition lh_upper = lh_lower.addOrReplaceChild("lh_upper",
                                CubeListBuilder.create().texOffs(46, 155).addBox(-4.25F, -10.0F, 0.0F, 4.0F, 10.0F,
                                                3.0F,
                                                new CubeDeformation(deformation)),
                                PartPose.offsetAndRotation(-0.75F, -9.0F, 1.0F, 0.3054F, 0.0F, -1.2654F));
                ...
                PartDefinition helm_rot = helm.addOrReplaceChild("helm_rot",
                                CubeListBuilder.create().texOffs(52, 129)
                                                .addBox(-1.5F, -4.0F, -4.5F, 6.0F, 6.0F, 6.0F,
                                                                new CubeDeformation(deformation))
                                                .texOffs(0, 137)
                                                .addBox(-1.5F, -10.0F, -4.5F, 6.0F, 6.0F, 6.0F,
                                                                new CubeDeformation(deformation))
                                                .texOffs(76, 137)
                                                .addBox(-1.5F, 2.0F, -4.5F, 6.0F, 6.0F, 6.0F,
                                                                new CubeDeformation(deformation))
                                                .texOffs(126, 76)
                                                .addBox(-5.5F, -4.0F, -4.5F, 4.0F, 4.0F, 3.0F,
                                                                new CubeDeformation(deformation))
                                                .texOffs(126, 66)
                                                .addBox(-9.5F, -4.0F, -4.5F, 8.0F, 4.0F, 6.0F,
                                                                new CubeDeformation(deformation))
                                                .texOffs(162, 126)
                                                .addBox(-5.5F, 0.0F, -4.5F, 4.0F, 2.0F, 3.0F,
                                                                new CubeDeformation(deformation))
                                                .texOffs(92, 116)
                                                .addBox(1.5F, -4.0F, 1.5F, 3.0F, 4.0F, 4.0F,
                                                                new CubeDeformation(deformation))
                                                .texOffs(92, 125)
                                                .addBox(-1.5F, -4.0F, 1.5F, 6.0F, 4.0F, 8.0F,
                                                                new CubeDeformation(deformation))
                                                .texOffs(158, 114).addBox(1.5F, 0.0F, 1.5F, 3.0F, 2.0F, 4.0F,
                                                                new CubeDeformation(deformation)),
                ...
                PartDefinition body = upper_body.addOrReplaceChild("body",
                                CubeListBuilder.create().texOffs(126, 0).addBox(
                ...
                PartDefinition rp_4 = right_plate.addOrReplaceChild("rp_4",
                                CubeListBuilder.create().texOffs(100, 137)
                                                .addBox(-0.25F, 9.75F, -3.0F, 4.0F, 10.0F, 6.0F,
                                                                new CubeDeformation(deformation))
                                                .texOffs(140, 76).addBox(-0.25F, -0.25F, -3.0F, 4.0F, 10.0F, 6.0F,
                                                                new CubeDeformation(deformation)),
                ...
                PartDefinition rp_5 = right_plate.addOrReplaceChild("rp_5",
                                CubeListBuilder.create().texOffs(140, 121)
                                                .addBox(-3.75F, 0.0F, -3.5F, 4.0F, 7.0F, 7.0F,
                                                                new CubeDeformation(deformation))
                                                .texOffs(140, 135)
                                                .addBox(0.25F, 0.0F, -3.5F, 4.0F, 7.0F, 7.0F,
                                                                new CubeDeformation(deformation))
                                                .texOffs(52, 141).addBox(0.25F, 7.0F, -3.5F, 4.0F, 7.0F, 7.0F,
                                                                new CubeDeformation(deformation)),
                ...
                PartDefinition lp_4 = left_plate.addOrReplaceChild("lp_4",
                                CubeListBuilder.create().texOffs(142, 92)
                                                .addBox(-3.75F, -0.25F, -3.0F, 4.0F, 10.0F, 6.0F,
                                                                new CubeDeformation(deformation))
                                                .texOffs(120, 146).addBox(-3.75F, 9.75F, -3.0F, 4.0F, 10.0F, 6.0F,
                                                                new CubeDeformation(deformation)),
                                PartPose.offsetAndRotation(0.25F, 0.25F, 0.0F, 0.0F, 0.0F, -0.3491F));

                PartDefinition lp_5 = left_plate.addOrReplaceChild("lp_5",
                                CubeListBuilder.create().texOffs(24, 147)
                                                .addBox(-4.25F, 0.0F, -3.5F, 4.0F, 7.0F, 7.0F,
                                                                new CubeDeformation(deformation))
                                                .texOffs(0, 149)
                                                .addBox(-4.25F, 7.0F, -3.5F, 4.0F, 7.0F, 7.0F,
                                                                new CubeDeformation(deformation))
                                                .texOffs(74, 149).addBox(-0.25F, 0.0F, -3.5F, 4.0F, 7.0F, 7.0F,
                                                                new CubeDeformation(deformation)),
                                PartPose.offsetAndRotation(0.5F, -1.25F, 0.0F, 0.0F, 0.0F, -0.7418F));
                ...
                PartDefinition chestplate_body_plackart_front = chestplate_body_plackart.addOrReplaceChild(
                                "chestplate_body_plackart_front", CubeListBuilder.create(),
                ...
                PartDefinition chestplate_body_plackart_front_center_x = chestplate_body_plackart_front_center
                                .addOrReplaceChild("chestplate_body_plackart_front_center_x",
                                                CubeListBuilder.create().texOffs(154, 64)
                                                                .addBox(-4.0F, -4.0F, 0.0F, 4.0F, 4.0F, 5.0F,
                                                                                new CubeDeformation(deformation))
                                                                .texOffs(162, 131)
                                                                .addBox(-7.0F, -4.0F, 0.0F, 3.0F, 4.0F, 3.0F,
                                                                                new CubeDeformation(deformation))
                                                                .texOffs(162, 99).addBox(-4.0F, -7.0F, 0.0F, 4.0F, 3.0F,
                                                                                3.0F, new CubeDeformation(deformation)),
                                                PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.7854F));

                PartDefinition chestplate_body_plackart_back = chestplate_body_plackart.addOrReplaceChild(
                                "chestplate_body_plackart_back", CubeListBuilder.create(),
                ...
                PartDefinition chestplate_body_plackart_back_center_x = chestplate_body_plackart_back_center
                                .addOrReplaceChild(
                                                "chestplate_body_plackart_back_center_x",
                                                CubeListBuilder.create().texOffs(76, 129)
                                                                .addBox(0.0F, -5.0F, -2.0F, 5.0F, 5.0F, 3.0F,
                                                                                new CubeDeformation(deformation))
                                                                .texOffs(118, 162)
                                                                .addBox(5.0F, -5.0F, -2.0F, 3.0F, 5.0F, 3.0F,
                                                                                new CubeDeformation(deformation))
                                                                .texOffs(142, 114).addBox(0.0F, -8.0F, -2.0F, 5.0F,
                                                                                3.0F, 3.0F,
                                                                                new CubeDeformation(deformation)),
                ...
                PartDefinition cape = middle_armor
                                .addOrReplaceChild("cape",
                                                CubeListBuilder.create().texOffs(0, 75).addBox(-10.0F, 0.0F, -1.0F,
                                                                20.0F, 36.0F, 1.0F,
                                                                new CubeDeformation(deformation)),
                ...
                PartDefinition rp_1 = rp_0.addOrReplaceChild("rp_1",
                                CubeListBuilder.create().texOffs(80, 30)
                                                .addBox(-11.75F, -0.25F, -4.0F, 12.0F, 4.0F, 8.0F,
                                                                new CubeDeformation(deformation))
                                                .texOffs(0, 0)
                                                .addBox(-19.75F, 1.75F, -8.0F, 19.0F, 0.0F, 16.0F,
                                                                new CubeDeformation(deformation))
                                                .texOffs(0, 112).addBox(-19.75F, -0.25F, -4.0F, 8.0F, 4.0F, 8.0F,
                                                                new CubeDeformation(deformation)),
                ...
                PartDefinition rp_2 = rp_0.addOrReplaceChild("rp_2",
                                CubeListBuilder.create().texOffs(92, 70)
                                                .addBox(-8.0F, 0.0F, -4.5F, 8.0F, 4.0F, 9.0F,
                                                                new CubeDeformation(deformation))
                                                .texOffs(70, 0)
                                                .addBox(-14.0F, 1.0F, -7.5F, 13.0F, 0.0F, 15.0F,
                                                                new CubeDeformation(deformation))
                                                .texOffs(32, 116)
                                                .addBox(-8.0F, -4.0F, -4.5F, 6.0F, 4.0F, 9.0F,
                                                                new CubeDeformation(deformation))
                                                .texOffs(62, 116).addBox(-14.0F, 0.0F, -4.5F, 6.0F, 4.0F, 9.0F,
                                                                new CubeDeformation(deformation)),
                ...
                PartDefinition lp_1 = lp_0.addOrReplaceChild("lp_1",
                                CubeListBuilder.create().texOffs(80, 42)
                                                .addBox(-0.25F, -0.25F, -4.0F, 12.0F, 4.0F, 8.0F,
                                                                new CubeDeformation(deformation))
                                                .texOffs(112, 54)
                                                .addBox(11.75F, -0.25F, -4.0F, 8.0F, 4.0F, 8.0F,
                                                                new CubeDeformation(deformation))
                                                .texOffs(0, 16).addBox(0.75F, 1.75F, -8.0F, 19.0F, 0.0F, 16.0F,
                                                                new CubeDeformation(deformation)),
                                PartPose.offsetAndRotation(-0.5F, -1.0F, 0.0F, 0.0F, 0.0F, -0.1745F));

                PartDefinition lp_2 = lp_0.addOrReplaceChild("lp_2",
                                CubeListBuilder.create().texOffs(106, 83)
                                                .addBox(0.0F, 0.0F, -4.5F, 8.0F, 4.0F, 9.0F,
                                                                new CubeDeformation(deformation))
                                                .texOffs(120, 30)
                                                .addBox(8.0F, 0.0F, -4.5F, 6.0F, 4.0F, 9.0F,
                                                                new CubeDeformation(deformation))
                                                .texOffs(0, 124)
                                                .addBox(2.0F, -4.0F, -4.5F, 6.0F, 4.0F, 9.0F,
                                                                new CubeDeformation(deformation))
                                                .texOffs(70, 15).addBox(1.0F, 1.0F, -7.5F, 13.0F, 0.0F, 15.0F,
                                                                new CubeDeformation(deformation)),
                                PartPose.offsetAndRotation(-0.5F, -1.25F, 0.0F, 0.0F, 0.0F, -0.6109F));
                ...
                PartDefinition blade = sword_rot.addOrReplaceChild("blade",
                                CubeListBuilder.create().texOffs(106, 96)
                                                .addBox(-4.0F, -29.0F, -23.5F, 8.0F, 28.0F, 1.0F,
                                                                new CubeDeformation(deformation))
                                                .texOffs(30, 129).addBox(-4.5F, -1.0F, -24.0F, 9.0F, 16.0F, 2.0F,
                                                                new CubeDeformation(deformation)),
                                PartPose.offset(0.0F, -29.0F, 24.0F));

                PartDefinition edge = blade.addOrReplaceChild("edge",
                                CubeListBuilder.create().texOffs(124, 121).addBox(-3.5F,
                                                -12.0F, -0.5F, 7.0F, 24.0F, 1.0F, new CubeDeformation(0.005F)),
                                PartPose.offset(0.0F, -41.0F, -23.0F));
                ...
                PartDefinition guard = handle
                                .addOrReplaceChild("guard",
                                                CubeListBuilder.create().texOffs(126, 16).addBox(-4.0F, -4.0F, -2.5F,
                                                                8.0F, 8.0F, 5.0F,
                                                                new CubeDeformation(deformation)),
                ...
                PartDefinition cube_r2 = guard.addOrReplaceChild("cube_r2",
                                CubeListBuilder.create().texOffs(84, 163)
                                                .addBox(-2.5F, -2.5F, -0.5F, 5.0F, 5.0F, 1.0F,
                                                                new CubeDeformation(deformation))
                                                .texOffs(72, 163).addBox(-2.5F, -2.5F, -6.5F, 5.0F, 5.0F, 1.0F,
                                                                new CubeDeformation(deformation)),
                ...
                PartDefinition cube_r3 = guard.addOrReplaceChild("cube_r3",
                                CubeListBuilder.create().texOffs(140, 149)
                                                .addBox(-8.0F, -16.0F, 0.0F, 10.0F, 16.0F, 0.0F,
                                                                new CubeDeformation(deformation))
                                                .texOffs(124, 96)
                                                .addBox(-1.5F, -16.0F, -4.5F, 0.0F, 16.0F, 9.0F,
                                                                new CubeDeformation(deformation))
                                                .texOffs(60, 155).addBox(-3.0F, -10.0F, -1.5F, 3.0F, 10.0F, 3.0F,
                                                                new CubeDeformation(deformation)),
                ...
                PartDefinition cube_r4 = guard.addOrReplaceChild("cube_r4",
                                CubeListBuilder.create().texOffs(120, 43)
                                                .addBox(-16.0F, -8.0F, 0.0F, 16.0F, 10.0F, 0.0F,
                                                                new CubeDeformation(deformation))
                                                .texOffs(42, 75)
                                                .addBox(-16.0F, -1.5F, -4.5F, 16.0F, 0.0F, 9.0F,
                                                                new CubeDeformation(deformation))
                                                .texOffs(142, 108).addBox(-10.0F, -3.0F, -1.5F, 10.0F, 3.0F, 3.0F,
                                                                new CubeDeformation(deformation)),
                ...
                PartDefinition hilt = handle.addOrReplaceChild("hilt",
                                CubeListBuilder.create().texOffs(152, 30)
                                                .addBox(5.5F, 5.0F, -3.0F, 3.0F, 14.0F, 3.0F,
                                                                new CubeDeformation(deformation))
                                                .texOffs(152, 47).addBox(5.5F, 5.0F, -3.0F, 3.0F, 14.0F, 3.0F,
                                                                new CubeDeformation(0.25F + deformation)),
                ...
                PartDefinition cube_r6 = pommel
                                .addOrReplaceChild("cube_r6",
                                                CubeListBuilder.create().texOffs(110, 153).addBox(0.0F, 0.0F, -4.0F,
                                                                0.0F, 12.0F, 4.0F,
                                                                new CubeDeformation(deformation)),
                                                PartPose.offsetAndRotation(0.0F, 7.25F, 2.0F, 0.3927F, 0.0F, 0.0F));
                ...
                PartDefinition cube_r7 = pommel.addOrReplaceChild("cube_r7",
                                CubeListBuilder.create().texOffs(162, 120)
                                                .addBox(2.0F, -2.0F, -1.0F, 5.0F, 4.0F, 2.0F,
                                                                new CubeDeformation(deformation))
                                                .texOffs(162, 138)
                                                .addBox(-2.0F, 2.0F, -1.0F, 4.0F, 5.0F, 2.0F,
                                                                new CubeDeformation(deformation))
                                                .texOffs(160, 73).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F,
                                                                new CubeDeformation(deformation)),
        ...
        public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
                ...
                this.animate(entity.swingComboTripleAnimationState, EnderKeeperAnimations.SWING_COMBO_TRIPLE,
                                ageInTicks);
