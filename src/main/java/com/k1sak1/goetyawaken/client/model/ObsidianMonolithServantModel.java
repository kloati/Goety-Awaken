...
public class ObsidianMonolithServantModel<T extends ObsidianMonolithServant> extends EntityModel<T> {
    public final ModelPart monolith;

    public ObsidianMonolithServantModel(ModelPart root) {
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
        ...
        if (entity.isEmerging() || entity.isDescending()) {
            this.monolith.y = (ObsidianMonolithServant.getEmergingTime()) - limbSwing;
        } else {
            this.monolith.y = 0;
        }
    }
