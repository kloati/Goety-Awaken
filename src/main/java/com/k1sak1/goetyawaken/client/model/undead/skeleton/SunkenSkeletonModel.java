package com.k1sak1.goetyawaken.client.model.undead.skeleton;
...
public class SunkenSkeletonModel<T extends SunkenSkeleton> extends HumanoidModel<T> {
    public SunkenSkeletonModel(ModelPart pModelPart) {
        super(pModelPart);
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        partdefinition.addOrReplaceChild("body",
                CubeListBuilder.create().texOffs(16, 16).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F)
                        ...
                        .texOffs(12, 30).addBox(2.0F, 12.0F, -2.0F, 2.0F, 2.0F, 0.0F),
                PartPose.offset(0.0F, 0.0F, 0.0F));
        partdefinition.addOrReplaceChild("head",
                CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F)
                        .texOffs(32, 0).addBox(-1.0F, -16.0F, -4.0F, 9.0F, 10.0F, 0.0F)
                        .texOffs(48, 0).addBox(-1.0F, -3.0F, 2.0F, 6.0F, 0.0F, 4.0F),
                PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        partdefinition.addOrReplaceChild("right_leg",
                CubeListBuilder.create().texOffs(0, 16).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 12.0F, 2.0F)
                        .texOffs(24, 4).addBox(-2.0F, 4.0F, -2.0F, 2.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)),
    ...
    public void posingRightArm(T pEntity) {
        switch (this.rightArmPose) {
            ...
            case CROSSBOW_CHARGE -> AnimationUtils.animateCrossbowCharge(this.rightArm, this.leftArm, pEntity, true);
            case CROSSBOW_HOLD -> AnimationUtils.animateCrossbowHold(this.rightArm, this.leftArm, this.head, true);
        }
    }

    public void posingLeftArm(T pEntity) {
        switch (this.leftArmPose) {
            ...
            case CROSSBOW_CHARGE -> AnimationUtils.animateCrossbowCharge(this.rightArm, this.leftArm, pEntity, false);
