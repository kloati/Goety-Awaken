...
public class BoundSorcererModel<T extends BoundSorcerer> extends HumanoidModel<T> implements HierarchicalArmor {
    ...
    public BoundSorcererModel(ModelPart root) {
        super(root);
        this.clothes = root.getChild("body").getChild("clothes");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition cape = body.addOrReplaceChild("cape", CubeListBuilder.create().texOffs(64, 43).addBox(
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
        ...
        this.body.xRot = f4 * com.Polarice3.Goety.utils.MathHelper.modelDegrees(40.0F);
    ...
    // public void prepareMobModel(T entityIn, float limbSwing, float
    // limbSwingAmount, float partialTick) {
    ...
    // if (entityIn.getArmPose() != AbstractBoundIllager.BoundArmPose.CROSSED) {
    // this.rightArmPose = ArmPose.EMPTY;
