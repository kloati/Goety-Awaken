...
public class HostileIllagerModel<T extends LivingEntity> extends HierarchicalModel<T>
    ...
    public HostileIllagerModel(ModelPart root) {
        this.root = root;
    ...
    public static MeshDefinition createMesh() {
        ...
        partdefinition1.addOrReplaceChild("collar", CubeListBuilder.create().texOffs(32, 0).addBox(-4.0F, -10.0F, -4.0F,
                8.0F, 10.0F, 8.0F, new CubeDeformation(0.45F)), PartPose.ZERO);
        ...
        body.addOrReplaceChild("clothes", CubeListBuilder.create().texOffs(0, 38).addBox(-4.0F, -24.0F, -3.0F, 8.0F,
                20.0F, 6.0F, new CubeDeformation(0.5F)), PartPose.offset(0.0F, 24.0F, 0.0F));
    ...
    public void setupAnim(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
        ...
        if (entityIn instanceof AbstractIllager servant) {
        ...
        if (entityIn instanceof AbstractIllager servant) {
            AbstractIllager.IllagerArmPose armPose = servant.getArmPose();
            if (armPose == AbstractIllager.IllagerArmPose.ATTACKING) {
                ...
                this.LeftArm.zRot = -2.3561945F;
                this.LeftArm.yRot = 0.0F;
            } else if (armPose == AbstractIllager.IllagerArmPose.CROSSED && this.arms.visible) {
    ...
    public void renderToBuffer(PoseStack p_102034_, VertexConsumer p_102035_, int p_102036_, int p_102037_,
        ...
        if (this.young) {
            ...
            this.headParts().forEach((p_102081_) -> {
                p_102081_.render(p_102034_, p_102035_, p_102036_, p_102037_, p_102038_, p_102039_, p_102040_,
                        p_102041_);
            });
            p_102034_.popPose();
            p_102034_.pushPose();
            ...
            this.bodyParts().forEach((p_102071_) -> {
                p_102071_.render(p_102034_, p_102035_, p_102036_, p_102037_, p_102038_, p_102039_, p_102040_,
                        p_102041_);
            });
            p_102034_.popPose();
        } else {
            super.renderToBuffer(p_102034_, p_102035_, p_102036_, p_102037_, p_102038_, p_102039_, p_102040_,
                    p_102041_);
        }

    }

    public void copyPropertiesTo(HostileIllagerModel<T> p_102873_) {
    ...
    public void useItemRight(InteractionHand hand, T entityIn) {
        if (entityIn.getUsedItemHand() == hand) {
            if (entityIn.getUseItem().getItem() instanceof SpyglassItem) {
                this.RightArm.xRot = Mth
                        .clamp(this.head.xRot - 1.9198622F - (entityIn.isCrouching() ? 0.2617994F : 0.0F), -2.4F, 3.3F);
