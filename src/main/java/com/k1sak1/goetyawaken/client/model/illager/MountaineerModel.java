...
public class MountaineerModel<T extends LivingEntity> extends HostileIllagerModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		MeshDefinition meshdefinition = HostileIllagerModel.createMesh();
		...
		PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm",
				CubeListBuilder.create().texOffs(40, 46)
						...
						.texOffs(44, 22).addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.5F)),
				PartPose.offset(5.0F, 2.0F, 0.0F));
