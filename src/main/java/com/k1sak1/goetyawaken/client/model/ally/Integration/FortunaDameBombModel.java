...
public class FortunaDameBombModel<T extends Entity> extends EntityModel<T> {
	...
	public FortunaDameBombModel(ModelPart modelPart) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		partdefinition.addOrReplaceChild("main", CubeListBuilder.create().texOffs(0, 0).addBox(-4, -4, -4, 8, 8, 8),
				PartPose.ZERO);
