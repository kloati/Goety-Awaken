...
@OnlyIn(Dist.CLIENT)
public class WitherServantModel extends EntityModel<WitherServant> {
    ...
    public WitherServantModel(ModelPart pRoot) {
    ...
    public static LayerDefinition createBodyLayer(CubeDeformation pCubeDeformation) {
        ...
        partdefinition.addOrReplaceChild("shoulders",
                CubeListBuilder.create().texOffs(0, 16).addBox(-10.0F, 3.9F, -0.5F, 20.0F, 3.0F, 3.0F,
                        pCubeDeformation),
                PartPose.ZERO);
        float f = 0.20420352F;
        partdefinition.addOrReplaceChild("ribcage",
                CubeListBuilder.create().texOffs(0, 22).addBox(0.0F, 0.0F, 0.0F, 3.0F, 10.0F, 3.0F, pCubeDeformation)
                        .texOffs(24, 22)
                        .addBox(-4.0F, 1.5F, 0.5F, 11.0F, 2.0F, 2.0F, pCubeDeformation).texOffs(24, 22)
                        .addBox(-4.0F, 4.0F, 0.5F, 11.0F, 2.0F, 2.0F, pCubeDeformation).texOffs(24, 22)
        ...
        partdefinition.addOrReplaceChild("tail",
                ...
                PartPose.offsetAndRotation(-2.0F, 6.9F + Mth.cos(0.20420352F) * 10.0F,
                        -0.5F + Mth.sin(0.20420352F) * 10.0F, 0.83252203F, 0.0F, 0.0F));
        partdefinition.addOrReplaceChild("center_head",
                CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F, pCubeDeformation),
                PartPose.ZERO);
        CubeListBuilder cubelistbuilder = CubeListBuilder.create().texOffs(32, 0).addBox(-4.0F, -4.0F, -4.0F, 6.0F,
                6.0F, 6.0F, pCubeDeformation);
    ...
    @Override
    public void setupAnim(WitherServant entity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks,
    ...
    public void prepareMobModel(WitherServant entity, float pLimbSwing, float pLimbSwingAmount, float pPartialTick) {
        setupHeadRotation(entity, this.rightHead, 1);
        setupHeadRotation(entity, this.leftHead, 2);
    }

    private static void setupHeadRotation(WitherServant wither, ModelPart pPart, int pHead) {
        pPart.yRot = (wither.getHeadYRot(pHead) - wither.yBodyRot) * ((float) Math.PI / 180F);
        pPart.xRot = wither.getHeadXRot(pHead) * ((float) Math.PI / 180F);
    }
